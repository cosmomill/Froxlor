...
CREATE TABLE `panel_customers` (
  ...
  `email_lastaccountnumber` int(11) NOT NULL default '0',
...
INSERT INTO `panel_settings` (`settinggroup`, `varname`, `value`) VALUES ('customer', 'emailprefix', 'pop');
...
INSERT INTO `panel_settings` (`settinggroup`, `varname`, `value`) VALUES ('panel', 'default_theme', 'Classic');
...
INSERT INTO `panel_languages` VALUES (18, 'Deutsch', 'lng/modules/email/german.lng.php');
INSERT INTO `panel_languages` VALUES (19, 'English', 'lng/modules/email/english.lng.php');
