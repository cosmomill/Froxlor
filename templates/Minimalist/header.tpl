...
<head>
	...
	<link rel="stylesheet" href="templates/Minimalist/main.css" type="text/css" />
	<script type="text/javascript" src="js/jquery.min.js"></script>
	<script type="text/javascript" src="templates/Minimalist/js/froxlor.js"></script>
...
<table cellspacing="0" cellpadding="0" border="0" width="<if isset($userinfo['loginname'])>100%<else>40%</if>" align="center">
	<tr>
		<if isset($userinfo['loginname'])>
			<td width="240" valign="top" bgcolor="#FFFFFF">$navigation<br /></td>
