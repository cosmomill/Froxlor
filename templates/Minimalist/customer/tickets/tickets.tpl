$header
	...
	<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
		<tr>
			<td class="maintitle_search_left"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['ticket']['supportstatus']}</b></td>
	...
	<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
		<tr>
			<td class="maintitle_search_left"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['menue']['ticket']['ticket']}</b></td>
