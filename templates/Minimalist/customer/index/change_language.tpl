$header
	<form method="post" action="{$linker->getLink(array('section' => 'index'))}">
		...
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable_60">
			<tr>
				<td class="none" rowspan="4"><img src="images/Minimalist/changelanguage.gif" alt="" /></td>
			</tr>
			<tr>
				<td class="maintitle" colspan="2"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['menue']['main']['changelanguage']}</b></td>
			</tr>
			<tr>
