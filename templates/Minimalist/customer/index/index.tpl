$header
	<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
		<tr>
			<td class="maintitle" colspan="2"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['index']['customerdetails']}</b></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="maintitle" colspan="2"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['index']['accountdetails']}</b></td>
		</tr>
		<tr>
