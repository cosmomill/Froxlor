$header
	<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable_60">
		<tr>
			<td class="maintitle" colspan="2"><b>&nbsp;<img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['success']['success']}</b></td>
		</tr>
		<tr>
			<td class="field_name_center_noborder"><img src="images/Minimalist/info.png" alt="" /></td>
