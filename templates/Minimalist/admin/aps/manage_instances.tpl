<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
	<tr>
		<td  class="maintitle" colspan="2"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['aps']['specialoptions']}</b></td>
	</tr>
	<tr>
...
<form method="post" action="$filename">
	...
	<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
		<tr>
			<td  class="maintitle" colspan="3"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['aps']['manageinstances']}</b></td>
		</tr>
		<tr>
