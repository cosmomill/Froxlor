$header
	<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
		<tr>
			<td colspan="4" class="maintitle"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['admin']['templates']['templates']}</b></td>
		</tr>
		<tr>
	...
	<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
		<tr>
			<td colspan="3" class="maintitle"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['admin']['templates']['filetemplates']}</b></td>
		</tr>
		<tr>
