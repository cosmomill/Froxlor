$header
	<form method="post" action="$filename">
		...
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable_60">
			<tr>
				<td class="maintitle" colspan="2"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['admin']['froxlorclients']['edit']}</b></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="maintitle_apply_left">
					<b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['admin']['froxlorclients']['client']}</b>
				</td>
