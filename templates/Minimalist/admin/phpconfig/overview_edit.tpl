$header
	<form action="{$linker->getLink(array('section' => 'phpsettings'))}" method="post">
		...
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable">
			<tr>
				<td class="maintitle" colspan="2"><b><img src="images/Minimalist/title.gif" alt="{$title}" />&nbsp;{$title}</b></td>
			</tr>
			{$phpconfig_edit_form}
		</table>
	</form>
	...
	<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
		<tr>
			<td class="maintitle" colspan="2"><b>&nbsp;<img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['admin']['phpconfig']['template_replace_vars']}</b></td>
		</tr>
		<tr>
