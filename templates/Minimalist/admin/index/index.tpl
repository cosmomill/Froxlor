$header
	<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
		<tr>
			<td colspan="2" class="maintitle"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['admin']['ressourcedetails']}</b></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" class="maintitle"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['admin']['systemdetails']}</b></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" class="maintitle"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['admin']['froxlordetails']}</b></td>
		</tr>
		{$outstanding_tasks}		
		{$cron_last_runs}
		<tr>
