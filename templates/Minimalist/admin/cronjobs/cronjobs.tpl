$header
	<form action="$filename" method="post">
		...
		<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
			<tr>
				<td class="maintitle"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['admin']['warning']}</b></td>
			</tr>
			<tr>
		...
		<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
			<tr>
				<td class="maintitle" colspan="5"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['admin']['cron']['cronsettings']}</b></td>
			</tr>
			<tr>
