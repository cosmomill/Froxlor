$header
	<form action="{$linker->getLink(array('section' => 'tickets'))}" method="post">
		...
		<tr>
			<td class="maintitle_search_left"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['ticket']['lastarchived']}</b></td>
	...
	<form action="{$linker->getLink(array('section' => 'tickets'))}" method="post">
		...
		<table cellpadding="5" cellspacing="4" border="0" align="center" class="maintable_60">
			<tr>
				<td class="maintitle" colspan="2"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['ticket']['search']}</b></td>
			</tr>
			<tr>
