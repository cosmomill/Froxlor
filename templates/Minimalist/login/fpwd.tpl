$header
	...
	<form method="post" action="$filename" name="loginform">
		...
		<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
			<tr>
				<td class="maintitle" colspan="2"><b>&nbsp;<img src="images/Minimalist/title.gif" alt="" />&nbsp;{$lng['error']['error']}/{$lng['error']['info']}</b></td>
			</tr>
			<tr>
				<td class="field_name_center_noborder" style="padding: 15px;"><img src="images/Minimalist/info.png" alt="" /></td>
		...
		<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
			<tr>
				<td class="maintitle" colspan="3"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;Froxlor&nbsp;-&nbsp;{$lng['login']['presend']}</b></td>
			</tr>
			<tr>
				<td rowspan="2" class="field_name_center"><img src="images/Minimalist/login.gif" alt="" /></td>
