$header
	...
	<form method="post" action="$filename" name="loginform">
		...
		<table cellpadding="5" cellspacing="0" border="0" align="center" class="maintable">
			<tr>
				<td class="maintitle" colspan="3"><b><img src="images/Minimalist/title.gif" alt="" />&nbsp;Froxlor&nbsp;-&nbsp;Login</b></td>
			</tr>
			<tr>
				<td rowspan="3" class="field_name_center"><img src="images/Minimalist/login.gif" alt="" /></td>
